...
public class BanTempory extends Ban{

	protected Calendar untilDate = Calendar.getInstance();
	
	public BanTempory(String playerName, String executorName, Calendar untilDate) {
		super(playerName, executorName);
		setType("BanTempory");
		setUntilDate(untilDate);
	}
	public BanTempory(String playerName, String executorName, String untilDate) {
		super(playerName, executorName);
		setType("BanTempory");
		setUntilDate(untilDate);
	}

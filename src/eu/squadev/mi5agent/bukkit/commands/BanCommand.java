...
public class BanCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String lbl, String[] args) {
		if(sender.hasPermission("mi5agent.ban")) {
			if(args.length > 0) {
				...
				Mi5Agent.getManager().ban(args[0], reason, sender.getName());
				Bukkit.broadcastMessage("§8§l[MI5Agent] §a"+args[0]+" §8a été banni pour§c "+reason);
				return true;
			}else {
